...
Even though components 2-4 do not need the state, they have to pass the state along so that it could reach component 5.
...
function Component1() {
  const [user, setUser] = useState("Robert Loblaw");
